...
function ChildApp(){
    ...
    return (
        <>
            <div>
                {/* So any container that takes some time can be wrapped inside Suspensr api from react */}
...
function Todo({id}){
    ...
    // -----------------------------------CODE FOR CHECKING LOADABLE hooks --------------------------------------------
...
// WRITE ERRROR BOUNDARY CLASS BASED COMPONENT HERE
// Class ErrorBoundary from Component{
